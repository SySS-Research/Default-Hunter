...
http_schema = {
    "auth": {
        ...
        "schema": {
            ...
            "headers": {"type": "list", "required": False, "schema": {"type": "dict"}},
            "csrf": {
                "type": "string",
                "nullable": True,
                "required": False,
            ...
            "type": {"type": "string", "regex": "post|basic_auth|get|raw_post", "required": True},
            "url": {"type": "list", "required": True, "schema": {"type": "string"}},
        },
    },
...
def mkcred():
    ...
    while True:
        header = cli_prompt(
            "Pleae enter any custom header needed. Hit enter if done or not needed \n Example: Content-Type: application/json: "
        )
        if len(header) > 0:
